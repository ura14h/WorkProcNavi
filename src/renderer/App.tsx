        ...
        {screen === "home" ? (
          ...
          >
            <div className="drop-zone__panel">
              ...
              <h2>手順書または途中経過ファイルをドロップしてください</h2>
              <p>
                md ファイルと zip ファイルは手順書、session ファイルは途中経過ファイルです。ここへドロップすると、
                まず概要を確認してから手順の確認を始められます。
              </p>
              <ul className="spec-list">
                <li>手順書または途中経過ファイルをドロップしてください。</li>
                <li>概要画面でフェーズ数やステップ数を確認して開始してください。</li>
                <li>各ステップの確認項目をチェックしながら進めてください。</li>
                <li>最後に作業結果をエビデンスとして出力します。</li>
              </ul>
            </div>
          </section>
        ) : null}
